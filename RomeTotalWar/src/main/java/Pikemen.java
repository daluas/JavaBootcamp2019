public class Pikemen implements Unit{
    private Double attackPoints = 17.0;
    private Double defensePoints = 12.0;
    private Double phalanxBonus = 9.0;
    ...
    public Double getDefensePower() {
        return defensePoints*phalanxBonus;
    }
    ...
    public void setPhalanxBonus(Double phalanxBonus) {
        this.phalanxBonus = phalanxBonus;
    }
}
